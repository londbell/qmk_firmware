...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    LAYOUT(
		KC_F13,  KC_ESC,  KC_1,     KC_2,     KC_3,     KC_4,     KC_5,      KC_6,     KC_7,     KC_8,     KC_9,     KC_0,    KC_MINS,  KC_EQL,   KC_BSPC,  KC_MUTE,
...
// static virtual_timer_t print_timer;
// static bool vt_init = false;

// static void print_a_char(void *arg) {
//     chSysLock();
//     rgb_matrix_toggle();
//     SEND_STRING("555");
//     chSysUnlock();
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    //             if (!vt_init) {
    //                 chVTObjectInit(&print_timer);
    //                 vt_init = true;
    //             }
    //             if (chVTIsArmedI(&print_timer)) chVTReset(&print_timer);
    //             chVTSet(&print_timer, TIME_MS2I(2000), (vtfunc_t)print_a_char, NULL);
    //             SEND_STRING("123");
    //         } else {
    //             chVTReset(&print_timer);
    //         }
    //         return false;
