...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        KC_GRV,  KC_ESC,  KC_1,    KC_2,    KC_3,   KC_4,   KC_5,  KC_6,  KC_7,  KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC, KC_DEL,
    ...
    [1] = LAYOUT(
        ...
        KC_TRNS, KC_TRNS, BL_SW_0, BL_SW_1, BL_SW_2, BL_SW_3, BAU_TOG, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_BTSH, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
        KC_TRNS, KC_TRNS, BLE_TOG, USB_TOG, BLE_DEL, BLE_CLR, BLE_OFF,          KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
                 KC_TRNS, RGB_TOG, RGB_MOD, RGB_RMOD,RGB_VAI, RGB_VAD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
                 KC_TRNS, KC_LG,   KC_TRNS, KC_TRNS,                                              KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
    [2] = LAYOUT(
    ...
    switch (keycode) {
        ...
        case BAT_SHOW: {
            if (record->event.pressed) {
                ...
                if (bat_l_t <= 10) {
                    rgblight_blink_layer_repeat(11, 500, 4);
                } else if (bat_l_t <= 30) {
                    rgblight_blink_layer_repeat(12, 500, 4);
                } else if (bat_l_t <= 50) {
                    rgblight_blink_layer_repeat(13, 500, 4);
                } else if (bat_l_t <= 70) {
                    rgblight_blink_layer_repeat(14, 500, 4);
                } else if (bat_l_t <= 80) {
                    rgblight_blink_layer_repeat(15, 500, 4);
                } else {
                    rgblight_blink_layer_repeat(16, 500, 4);
                }
            }
        }
        return false;
