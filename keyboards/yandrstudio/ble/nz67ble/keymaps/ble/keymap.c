...
#    define RGB_ADV_BT BAT_SHOW
#elif defined(RGB_MATRIX_ENABLE)
#    define RGB_ADV_BT RGB_KG_T
#else
#    define RGB_ADV_BT KC_TRNS
#endif
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT(
		...
		KC_TRNS, RGB_TOG, RGB_MOD, RGB_RMOD,RGB_VAI, RGB_VAD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_ADV_BT,         KC_TRNS, KC_TRNS, KC_TRNS,
